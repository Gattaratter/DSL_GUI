#The following code was generated out of DSL-code from the file: ../../savefiles/DSL/TestMinConnection.cam
import sys
...
none = Camera("none", (117,117,0), "0.0.0.0", None)
devicesList.append(none)

none_1 = Sensor("none_1", (113,272,0))
devicesList.append(none_1)

none_none = Connection("none_none", none, none_1, "wire", "Pin1")
devicesList.append(none_none)
